...
let answer = {minute_most_slept_count:0};
Object.keys(guards).forEach((g_id)=>{
  if (guards[g_id].slept_minutes[guards[g_id].minute_most_slept] > answer.minute_most_slept_count)
   answer = {id:+g_id, total_slept_minutes: guards[g_id].total_slept_minutes, minute_most_slept: guards[g_id].minute_most_slept, minute_most_slept_count: guards[g_id].slept_minutes[guards[g_id].minute_most_slept]};
});
